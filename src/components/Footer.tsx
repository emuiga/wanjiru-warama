      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <p className="text-sm">
              © {new Date().getFullYear()}, Wanjiru Warama. All rights reserved | <a href="https://www.origin.co.ke">Origin</a>
            </p>
          </div>
          ...
          <div className="flex items-center space-x-6">
            <Link
              href="/contact"
              className="text-white hover:text-amber-200 transition-colors text-sm font-medium"
            >
              Contact
            </Link>
            ...
            <div className="flex space-x-4">
              ...
              >
                <Image src="/instagram.png" alt="Instagram" width={20} height={20} className="invert" />
              </a>
